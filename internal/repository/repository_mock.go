...
func (m *MockAllInRepo) FindEmail(s string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindEmail", s)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockAllInRepoMockRecorder) FindEmail(s any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindEmail", reflect.TypeOf((*MockAllInRepo)(nil).FindEmail), s)
}
...
func (m *MockAllInRepo) UpdatePassword(email, newPass string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdatePassword", email, newPass)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockAllInRepoMockRecorder) UpdatePassword(email, newPass any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatePassword", reflect.TypeOf((*MockAllInRepo)(nil).UpdatePassword), email, newPass)
}
